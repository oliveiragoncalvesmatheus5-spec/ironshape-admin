      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="bg-surface border border-white/5 rounded-3xl p-8 space-y-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-bold py-4 rounded-2xl hover:bg-gray-100 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
          ...
          <p className="text-center text-xs text-text-muted">
            Apenas o email administrador tem acesso.
          </p>
        </div>
      </div>
    </div>
